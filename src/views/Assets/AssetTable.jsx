                    ...
                    <table className="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                            ...
                            {!loading && assets.length === 0 && (
                                <tr>
                                    <td colSpan="7" className="text-center py-8 text-gray-500">No assets found.</td>
                                </tr>
                            )}
                            {!loading && assets.map(asset => (
                                <tr key={asset.id} className="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div className={`flex items-center gap-1 ${asset.current_value < asset.purchase_cost ? 'text-red-600' : 'text-green-600'}`}>
                                            {currencyFormat.format(asset.current_value)}
